...
import com.baidu.hackathon.search.constant.RequestUrl;
	...
	public static CloudSearchObj cloudInterfaceForOriginalPoiData(
		...
		try {
			...
			case SearchType.nearbySearch:
				...
				CloudHttpUtils.addParamToBuffer(buffer, "ak",
						GlobalConstant.CloudSearchAK, true);
				...
				CloudHttpUtils.addParamToBuffer(buffer, "page_size", page_size,
						false);
				CloudHttpUtils.addParamToBuffer(buffer, "page_index",
						page_index, false);
			...
			case SearchType.personalSearch:
				...
				CloudHttpUtils.addParamToBuffer(buffer, "geotable_id",
						GlobalConstant.geotable_id, false);
				CloudHttpUtils.addParamToBuffer(buffer, "q", "", false);
				CloudHttpUtils.addParamToBuffer(buffer, "page_size", page_size,
						false);
				CloudHttpUtils.addParamToBuffer(buffer, "page_index",
						page_index, false);
			...
			case SearchType.detailSearch:
				...
				CloudHttpUtils.addParamToBuffer(buffer, "geotable_id",
						GlobalConstant.geotable_id, false);
				CloudHttpUtils.addParamToBuffer(buffer, "id", poiId, false);
				break;
			default:
